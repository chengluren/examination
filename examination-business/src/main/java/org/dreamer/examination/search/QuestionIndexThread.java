 ...
 */
public class QuestionIndexThread extends Thread {
    private static Logger log = LoggerFactory.getLogger(QuestionIndexThread.class);

    private static int P_SIZE = 200;

    private QuestionService questionService;
    private Class<? extends Question> clazzType;
    private IndexAndSearchWrapper indexer;
    private String quesType = "";

    public QuestionIndexThread(QuestionService questionService,
    ...
    public void run() {
        ...
        Page<Object[]> quesInfo = questionService.getQuestionBaseInfo(clazzType, p);
